...
const main = async () => {
  ...
  const products = await productManager1.getProduct();
  ...
  // const productsUpdate = await productManager1.getProduct();
  // console.log("PRODUCTOS ACTUALIZADOS", productsUpdate);

  // await productManager1.deleteProduct(1);

  // const productsDeleted = await productManager1.getProduct();
